...
/// <exclude/>
public class SqliteRepositoryTests(ITestOutputHelper outputHelper)
{
    [Fact]
    public void RunTests()
    {
        ...
        outputHelper.WriteLine(testData1.Id.ToString());
        outputHelper.WriteLine(testData2.Id.ToString());
