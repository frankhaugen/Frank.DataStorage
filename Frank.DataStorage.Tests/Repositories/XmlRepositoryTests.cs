...
/// <exclude/>
public class XmlRepositoryTests : DataStorageTestBase<ExampleClass>
{
    public XmlRepositoryTests(ITestOutputHelper outputHelper) : base(outputHelper)
    {
    }
    
    /// <inheritdoc />
    public override StorageType GetStorageType() => StorageType.Xml;
