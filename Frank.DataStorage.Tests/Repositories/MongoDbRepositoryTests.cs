...
/// <exclude/>
public class MongoDbRepositoryTests : DataStorageTestBase<ExampleClass>
{
    /// <inheritdoc />
    public MongoDbRepositoryTests(ITestOutputHelper outputHelper) : base(outputHelper)
    {
    }

    /// <inheritdoc />
    public override StorageType GetStorageType() => StorageType.MongoDb;
    ...
    public async Task RunTests()
    {
        ...
        var repository = GetRepository<MongoDbRepository<ExampleClass>>();
