...
/// <exclude/>
public class CsvRepositoryTests : DataStorageTestBase<ExampleClass>
{
    public CsvRepositoryTests(ITestOutputHelper outputHelper) : base(outputHelper)
    {
    }

    /// <inheritdoc />
    public override StorageType GetStorageType() => StorageType.Csv;
    ...
    public async Task RunTests()
    {
        ...
        var repository = GetRepository<CsvRepository<ExampleClass>>();
