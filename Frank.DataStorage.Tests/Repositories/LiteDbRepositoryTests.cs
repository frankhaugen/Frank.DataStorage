...
/// <exclude/>
public class LiteDbRepositoryTests : DataStorageTestBase<ExampleClass>
{
    public LiteDbRepositoryTests(ITestOutputHelper outputHelper) : base(outputHelper)
    {
    }
    
    /// <inheritdoc />
    public override StorageType GetStorageType() => StorageType.LiteDb;
    ...
    public async Task RunTests()
    {
        ...
        var repository = GetRepository<LiteDbRepository<ExampleClass>>();
